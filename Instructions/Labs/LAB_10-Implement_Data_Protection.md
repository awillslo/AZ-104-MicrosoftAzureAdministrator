...
1. On the **Security Settings** blade, Uncheck **Enable soft delete for cloud workloads** and also uncheck **Enable soft delete and security settings for hybrid workloads** and click **Update**.
